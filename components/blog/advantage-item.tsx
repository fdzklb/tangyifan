...
export const AdvantageItem = async ({ blog }: BlogListItemProps) => {
  return (
    <div className="bg-[#E7E5E0] p-3 rounded-sm hover:shadow-md transition-shadow duration-500 ease-in-out">
      ...
      <div className="flex flex-col my-2 space-y-2">
        <div className="flex justify-between">
          <h2 className="text-xl text-gray-700">{blog.title}</h2>
        </div>
